          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(AppLocalizations.of(context)!.vouchers,
                      style: Styles.textStyle30.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                ...
                Center(
                  child: LocoButton(textOfButton: AppLocalizations.of(context)!.apply, onPressed: (){},)
                ),
                ...
                const SizedBox(height: 16,),
                 Row(
                  children: [
                    Text(AppLocalizations.of(context)!.shipping_fee,style:Styles.textStyle18.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                    ),),
                ...
                const SizedBox(height: 16,),
                 Row(
                  children: [
                    Text(AppLocalizations.of(context)!.discount,style:Styles.textStyle18.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                    ),),
                    const Padding(padding: EdgeInsets.only(left: 200)),
                ...
                const Divider(thickness: 0.8,),
                 Row(
                  children: [
                    Text(AppLocalizations.of(context)!.total,style:Styles.textStyle18.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                    ),),
                ...
                Center(
                  child: LocoButton(textOfButton: AppLocalizations.of(context)!.confirm, onPressed: (){
